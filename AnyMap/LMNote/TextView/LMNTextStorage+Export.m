...
//
                NSString *imgSrc = [(LMNImageLine*)line getimgURL];
                
                [html appendFormat:@"<div class=\"imgdiv\"><img class=\"img\"src=\"%@\" width=\"50%%\" height=\"30%%\" /></div>", imgSrc];
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [html insertString:@"<!DOCTYPE html><html><style type=\"text/css\">.title{font-size: 24px;};.subtitle {font-size: 20px;};.content{font-size: 17px;}.imgdiv{width: 100%;text-align: center;}</style><body>" atIndex:0];
