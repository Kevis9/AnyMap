...
- (void)initViews {
    ...
    [self.tableView registerClass:[EditStoryTableViewCell class] forCellReuseIdentifier:@"cell_story"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *cellIdentifier = @"cell_story";
    EditStoryTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier];
    
    if(indexPath.row==0){
        [cell.textview.placeholder setText:@"标题"];
        self.TitleTextView = cell.textview;
        NSLog(@"cell======%p======",self.TitleTextView);
    }
    else
    {
...
- (UIButton *)addPointbtn {
    if(_addPointbtn == nil){
        _addPointbtn = [[UIButton alloc] initWithFrame:CGRectMake(10,5,100,50)];
        _addPointbtn.backgroundColor = [UIColor blueColor];
        [_addPointbtn setTitle:@"新增地点" forState:UIControlStateNormal];
